...
int main(int argc, char* argv[]) {
  ...
  // dist/index.html'in gercek yolu. VPS'te build alinip Colab'a scp ile
  // cekilen React ciktisi bu dizine kopyalanmali (henuz kesinlesmedi —
  // /agroos/webos/dist/index.html varsayimi, gercek AgroOS dosya duzenine
  // gore ayarlanacak).
